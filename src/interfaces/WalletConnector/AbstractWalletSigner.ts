...
export abstract class AbstractWalletSigner<T extends NetworkBase>
  implements TwoWaySigner<T>
{
  protected constructor(
    private _identNervos: NervosNetwork["UserIdent"],
    private _identXChain: T["UserIdent"]
  ) {}
