...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    REACT_APP_CKB_INDEXER_RPC_URL: string;
    ...
    REACT_APP_SUDT_CODE_HASH: string;
    REACT_APP_SUDT_OUTPOINT_TXHASH: string;

    REACT_APP_ACS_REQUEST_OUTPOINT_TXHASH: string;
    REACT_APP_DEPLOY_METADATA_OUTPOINT_TXHASH: string;
    REACT_APP_ACS_REQUEST_TYPE_ID: string;
    REACT_APP_ACS_LOCK_TYPE_ID: string;
    REACT_APP_DEPLOY_METADATA_TYPE_ARGS: string;
