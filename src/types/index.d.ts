...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    REACT_SUDT_CODE_HASH: string;
    REACT_SUDT_OUTPOINT_TXHASH: string;

    REACT_ACS_REQUEST_OUTPOINT_TXHASH: string;
    REACT_DEPLOY_METADATA_OUTPOINT_TXHASH: string;
    REACT_ACS_REQUEST_TYPE_ID: string;
    REACT_ACS_LOCK_TYPE_ID: string;
    REACT_DEPLOY_METADATA_TYPE_ARGS: string;
