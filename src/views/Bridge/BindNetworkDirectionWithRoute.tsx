...
export const BindNetworkDirectionWithRoute: React.FC = () => {
  ...
  useMount(() => {
    ...
    if (
      fromNetwork === NERVOS_NETWORK &&
      bridge.supportedNetworks.includes(toNetwork)
    ) {
    ...
    if (
      toNetwork === NERVOS_NETWORK &&
      bridge.supportedNetworks.includes(fromNetwork)
    ) {
