...
export const ExpandRowContent: React.FC<ExpandRowContentProps> = (props) => {
  ...
  return (
    <div>
      ...
      {record.status === BridgeTransactionStatus.Successful &&
