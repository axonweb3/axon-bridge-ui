...
export const SwitchMetaMaskNetworkButton: React.FC<
  SwitchMetaMaskNetworkButtonProps
> = (props) => {
  const { chainId, chainName } = props;
  const { mutateAsync: switchMetaMaskNetwork, isLoading } =
    useSwitchMetaMaskNetwork();
